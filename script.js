function calculateROI() {
    ...
    document.getElementById('explainMonthlySavings').innerText = 
        `Monthly Savings = Reduced Samples × (Cost per Sample + Transportation Cost per Sample) = (${samplesPerMonth.toLocaleString()} * ${reductionPercentage .toLocaleString()}) × ($${costPerSample.toLocaleString()} + $${transportationCostPerSample.toLocaleString()}) = $${monthlySavings.toLocaleString()}`;
